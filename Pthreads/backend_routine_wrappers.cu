...
void cublas_wrap_daxpy(void* wider_backend_data){
  ...
  axpy_backend_in_p ptr_ker_translate = (axpy_backend_in_p) wider_data_p->backend_data;
...
void cublas_wrap_dgemm(void* wider_backend_data){
  ...
  gemm_backend_in_p ptr_ker_translate = (gemm_backend_in_p) wider_data_p->backend_data;
#ifdef DDEBUG
