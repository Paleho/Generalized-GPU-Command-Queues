...
int main(int argc, char ** argv){
	...
	gemm_backend_in<double>* gemmData_p_3_comb1a = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>*), -1);
	gemm_backend_in<double>* gemmData_p_3_comb1b = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>*), -1);
	gemm_backend_in<double>* gemmData_p_3_comb2a = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>*), -1);
	gemm_backend_in<double>* gemmData_p_3_comb2b = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>*), -1);
	gemm_backend_in<double>* gemmData_p_3_comb3a = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>*), -1);
	gemm_backend_in<double>* gemmData_p_3_comb3b = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>*), -1);
	gemm_backend_in<double>* gemmData_p_3_comb4a = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>*), -1);
	gemm_backend_in<double>* gemmData_p_3_comb4b = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>*), -1);
	...
	Event_p R22_part_ready_d2 = new Event(2);
	{
		...
		// Run blas operation
		backend_run_operation(gemmData_p_3_comb1a, "Dgemm", Q3[2]);
		// gemm stores result matrix in C = d2_M12A21B11
		...
		// Run blas operation
		backend_run_operation(gemmData_p_3_comb1b, "Dgemm", Q3[2]);
		// gemm stores result matrix in C = d2_M12A21B11
		...
		// Run blas operation
		backend_run_operation(gemmData_p_3_comb2a, "Dgemm", Q3[3]);
		// gemm stores result matrix in C = d2_M22A21B11
		...
		// Run blas operation
		backend_run_operation(gemmData_p_3_comb2b, "Dgemm", Q3[3]);
		// gemm stores result matrix in C = d2_M22A21B11
		...
		// Run blas operation
		backend_run_operation(gemmData_p_3_comb3a, "Dgemm", Q3[4]);
		// gemm stores result matrix in C = d2_M12A21B12
		...
		// Run blas operation
		backend_run_operation(gemmData_p_3_comb3b, "Dgemm", Q3[4]);
		// gemm stores result matrix in C = d2_M12A21B12
		...
		// Run blas operation
		backend_run_operation(gemmData_p_3_comb4a, "Dgemm", Q3[5]);
		// gemm stores result matrix in C = d2_M22A21B12
		...
		// Run blas operation
		backend_run_operation(gemmData_p_3_comb4b, "Dgemm", Q3[5]);
		// gemm stores result matrix in C = d2_M22A21B12
	...
	gemm_backend_in<double>* gemmData_p_R11 = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>), -1);
	gemm_backend_in<double>* gemmData_p_R12 = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>), -1);
	gemm_backend_in<double>* gemmData_p_R21 = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>), -1);
	gemm_backend_in<double>* gemmData_p_R22 = (gemm_backend_in<double>*) CoCoMalloc(sizeof(gemm_backend_in<double>), -1);
	{
		for(int i = 0; i < 6; i++){
		...
		// Run blas operation
		backend_run_operation(gemmData_p_R11, "Dgemm", Qhost[2]);
		...
		// Run blas operation
		backend_run_operation(gemmData_p_R21, "Dgemm", Qhost[3]);
		...
		// Run blas operation
		backend_run_operation(gemmData_p_R12, "Dgemm", Qhost[4]);
		...
		// Run blas operation
		backend_run_operation(gemmData_p_R22, "Dgemm", Qhost[5]);
